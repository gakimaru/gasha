...
public:
	//アロケータアダプター取得
	inline GASHA_ allocatorAdapter<lfPoolAllocator<_MAX_POOL_SIZE>> adapter(){ GASHA_ allocatorAdapter<lfPoolAllocator<_MAX_POOL_SIZE>> adapter(*this); return adapter; }
