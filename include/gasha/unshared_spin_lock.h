...
public:
	...
	inline GASHA_ unique_shared_lock<unsharedSpinLock> lockUnique(const GASHA_ try_lock_t);
	inline GASHA_ unique_shared_lock<unsharedSpinLock> lockUnique(const GASHA_ try_lock_shared_t);
