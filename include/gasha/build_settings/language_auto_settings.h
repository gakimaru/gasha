...
//※main()関数実行前および終了後に実行される関数を定義するための属性
	...
	#define GASHA_INIT_PRIORITY_ATTRIBUTE(PRIORITY)
#endif//GASHA_IS_VC
#ifdef GASHA_IS_GCC
	...
	#define GASHA_INIT_PRIORITY_ATTRIBUTE(PRIORITY) __attribute__((init_priority(PRIORITY)))
	...
	#define GASHA_HAS_INIT_PRIORITY_ATTRIBUTE
#endif//GASHA_IS_GCC
